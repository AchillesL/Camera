...
public class Constants {
    ...
    public static final String APP_ID = "DN9VdQbbdZgCmCmLwyJS8dnZd1BAz8yCSrjQC6NovAm6";
    public static final String SDK_KEY = "HHzLjDmZNqojMNphmxKWwYtUMiPvjU5mhHNi6aoM4Dnd";
